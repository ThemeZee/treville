...
function treville_block_editor_assets() {
	...
	wp_enqueue_style( 'treville-editor-styles', get_theme_file_uri( '/assets/css/gutenberg-styles.css' ), array(), '20210306', 'all' );
 ...
 */
function treville_block_editor_settings( $editor_settings ) {
...
#add_filter( 'block_editor_settings', 'treville_block_editor_settings', 11 );
