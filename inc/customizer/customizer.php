...
function treville_customize_preview_js() {
	wp_enqueue_script( 'treville-customizer-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20200410', true );
}
