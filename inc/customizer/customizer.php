...
function treville_customize_preview_js() {
	wp_enqueue_script( 'treville-customizer-preview', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20170806', true );
}
...
function treville_customize_preview_css() {
	wp_enqueue_style( 'treville-customizer-css', get_template_directory_uri() . '/assets/css/customizer.css', array(), '20170806' );
}
