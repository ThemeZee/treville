...
function treville_slider_scripts() {
	...
	if ( true === $theme_options['slider_blog'] or true === $theme_options['slider_magazine'] or is_page_template( 'template-slider.php' ) ) :
		...
		wp_enqueue_script( 'treville-slider', get_template_directory_uri() . '/js/slider.js', array( 'jquery-flexslider' ) );

		// Register and enqueue slider CSS.
		wp_enqueue_style( 'treville-slider', get_template_directory_uri() . '/css/flexslider.css' );
