...
function treville_scripts() {
	...
	if ( has_nav_menu( 'primary' ) || has_nav_menu( 'secondary' ) || has_nav_menu( 'social' ) ) {
		wp_enqueue_script( 'treville-navigation', get_theme_file_uri( '/assets/js/navigation.min.js' ), array( 'jquery' ), '20191114', true );
		$treville_l10n = array(
...
function treville_block_editor_assets() {
	wp_enqueue_style( 'treville-editor-styles', get_theme_file_uri( '/assets/css/gutenberg-styles.css' ), array(), '20191118', 'all' );
}
